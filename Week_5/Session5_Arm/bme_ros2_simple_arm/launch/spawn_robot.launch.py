...
def generate_launch_description():
    ...
    joint_trajectory_controller_spawner = Node(
        ...
        arguments=['arm_controller', 'gripper_controller', '--param-file', robot_controllers],
    ...
    gz_image_bridge_node = Node(
        package="ros_gz_image", executable="image_bridge", arguments=["/gripper_camera/image"], output="screen",
        parameters=[{'use_sim_time': LaunchConfiguration('use_sim_time'), 'gripper_camera.image.compressed.jpeg_quality': 75}]
    )
    relay_gripper_camera_info_node = Node(
        package='topic_tools', executable='relay', name='relay_camera_info', output='screen',
